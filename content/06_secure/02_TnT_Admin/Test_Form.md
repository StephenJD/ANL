...
<fieldset><legend>Role</legend>
  <fieldset id="role_chinley_cbox">
   <label><input type="checkbox">Chinley</label>
   <fieldset id="role_chinley_radio">
   <label><input required type="radio"> CLeader</label>
   <label><input required type="radio"> CHelper</label>
   </fieldset>
  </fieldset>
  
  <fieldset id="role_whaley_cbox">
   <label><input type="checkbox">Whaley Bridge</label>
   <fieldset id="role_whaley_radio">
   <label><input required type="radio"> WLeader</label>
   <label><input required type="radio"> WHelper</label>
   </fieldset>
  </fieldset>

  <fieldset id="role_newmills_cbox">
   <label><input type="checkbox">New Mills</label>
   <fieldset id="role_newmills_radio">
