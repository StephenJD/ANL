...
Some Personal Data is held, without requiring consent, because of a contractual arrangement:

- To manage contracts with employees and volunteers
- Contracts with people engaged to perform occasional services

## Legal Obligation

Some Personal Data is held to comply with legal requirements:

- Director/officer records
- Financial Gift Aid records
...
Some Personal Data is held for legitimate interest:

- Informing registered users of events or changes
- Publishing rota duties
- Enabling participation in groups or committees

## Explicit Consent

Some uses require explicit consent:
...
To exercise rights or raise concerns contact:

Stephen Dolley  
Ascend Next Level CIC GDPR Officer  
9 Lower Lane, Chinley  
07980 446573  
