...
let finalValue = valueArray;

if (valueArray.length && valueArray.every(v => v && typeof v === 'object' && !Array.isArray(v))) {
  finalValue = Object.assign({}, ...valueArray);
}

if (hasLegend) {
  return { [groupKey]: finalValue };
} else {
  return finalValue;
}
}
